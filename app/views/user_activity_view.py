...
class UserActivity(MethodView):
    ...
    def get(self):
        """ An function to implement the user activity if user want to see likes than type = likes or comments in args"""
        ...
        # if user passes the activity type = likes
        ...
        # if user passes the type = comments
