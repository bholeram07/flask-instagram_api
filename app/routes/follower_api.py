...
follower_api.add_url_rule(
    "/api/users/follow/", view_func=follower_view, methods=["POST"]
)
follower_api.add_url_rule(
    "/api/users/<username>/follow/", view_func=follower_view, methods=["DELETE"]
)
follower_api.add_url_rule(
    "/api/users/follower/", view_func=follower_view, methods=["GET"]
)
follower_api.add_url_rule(
    "/api/users/<username>/follower/", view_func=follower_view, methods=["GET"]
)


following_view = FollowingApi.as_view("following_api")
following_api.add_url_rule(
    "/api/users/following/", view_func=following_view, methods=["GET"]
)
following_api.add_url_rule(
    "/api/users/<username>/following/", view_func=following_view, methods=["GET"]
)
